			...
			switch (val2.toLowerCase()) {
				...
				case 'open':
					$.ajax({
						...
						dataType: "xml",
						data: {
							header: "verificarLabPrograma",
							labid: $("#form1input1").val(),
						...
						success: function (xml) {
							...
							if (code === "1") {
								...
								alert("Lo sentimos, el laboratorio ya realizó el enrolamiento para este programa.");
							}
						},
						error: function () {
							alert("No fue posible verificar el estado de enrolamiento.");
						}
					});

					break; // no abrir inmediatamente
