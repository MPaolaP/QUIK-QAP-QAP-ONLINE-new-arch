...
<body onload="initialize()">
	...
	<div class="col-xs-12 no-margin no-padding">
		<div class="col-xs-2 bg-white" style="height: 100vh; overflow: auto; z-index:100">
			...
			<div class="col-xs-12">
				<center>
					<span><a href="index_u.php"><img
								style="width: 100%; border-radius: 150px; border: 2px solid #1c50a4;"
								src="css/qap_logo.png"></img></a></span>
			...
			<div class="col-xs-12 no-padding" id="form1">
				...
				<hr />
				<div class="form-group">
					<button type="button" id='btn-config-analitos' class="btn btn-secondary btn-block"
						onmouseup="functionHandler('windowHandler','open','window2');" title="Configurar mensurandos"><i
							class="glyphicon glyphicon-pencil"></i>Configurar mis mensurandos</button>

					<a type="button" target='_blank' href='multimedia/quik_sas_politicas_qap_y_relacionadas.pdf'
						id='btn_panel_ayuda' class="btn btn-block">
						<i class="glyphicon glyphicon-info-sign"></i> Políticas Programas QAP
					</a>

					<a class="btn btn-primary btn-block" id='open_reports' target="_blank"><i
							class="glyphicon glyphicon-new-window"></i> Ver mis reportes QAP</a>
			...
			<div class="col-xs-12 no-padding">
				<ul class="list-group" id="form2">
					<li class="list-group-item pointer" id="form2input1"><b>Cerrar sesión <span
								class="glyphicon glyphicon-off pull-right"></span></b></li>
				</ul>
			</div>
		</div>
		<div class="col-xs-10 no-margin no-padding"
			style="height: 100vh; max-height: 100vh; max-width: 100%; overflow: auto;">
			<div class="col-xs-12 no-margin no-padding">
				<nav class="navbar navbar-default cube-box no-margin no-padding transparent-body">
					<span class="glass"></span>
					<ul class="nav navbar-nav inner-nav"
						style="padding: 5px 10px 5px 10px; font-size: 8pt; z-index:100; background-color: #fff;">
						...
						<label style="padding: 0px 5px 0px 5px;" class="control-label ">Dirección de
							laboratorio:</label>
			...
			<div class="col-xs-10 col-xs-offset-1 margin-top-1">
				<div class="panel panel-default cube-box no-margin sombra-tenue" id="w3p">
					...
					<div class="panel-body cube-box no-padding no-padding"
								...
								<table class="table table-condensed" id="table2">
									<thead>
										<tr>
											...
											<th class="center-text"><button id="form2Button1"
													class="btn btn-default btn-sm btn-block" type="button"><span
														class="glyphicon glyphicon-send"></span> Reportar</button></th>
										</tr>
									</thead>
									<tbody>
									</tbody>
			...
			<div class="panel-body">
				...
				<center>
					<input type="button" class="btn btn-default" value="Agregar"
						onmouseup="functionHandler('addAnalitResultComment','w1textarea1','table2','window1')">
				</center>
			</div>
		</div>
	</div>
	<div class="col-xs-10 floating center" id="window2" hidden="hidden" data-item="window">
		<div class="panel panel-default shadow" id="w2p">
			<div class="panel-heading">
				...
				<button onmouseup="functionHandler('windowHandler','open','window2');" type="button" class="close">
					<span aria-hidden="true">&times;</span>
					<span class="sr-only">Close</span>
				</button>
			</div>
			<div class="panel-body no-padding" style="height: 75vh; max-height: 75vh;">
				...
				<div class="col-xs-8" style="max-height: inherit; overflow: auto;">
					<table class="table table-condensed" id="table15">
						<thead>
							<tr>
								<th colspan="10"><input type="text" class="form-control input-sm"
					...
					<table class="table table-condensed table-hover" id="table250">
						<thead>
							...
							<tr>
								...
								<th class="center-text"><button id="table250input1" class="btn btn-default btn-sm"
										type="button" style="width: 83%;"><span
											class="glyphicon glyphicon-floppy-disk"></span> Guardar</button></th>
							</tr>
						</thead>
						<tbody>
						</tbody>
